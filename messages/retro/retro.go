...
const INIT_CALLBACK_ID = "scrum-master-retro-selected-action"

func GetInitRetroMessage(username string) slack.Attachment {
	return slack.Attachment{
		Text:       fmt.Sprintf("Hey @%s! Please choose what you wan to do below : ", username),
		Color:      "#3AA3E3",
		...
		Actions: []slack.AttachmentAction{
			...
			{Name: "sprint", Text: "Abort Retro", Type: "button", Value: "scrum-master-retro-action-abort-retro", Style: "danger"},
